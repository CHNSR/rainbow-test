...
class HiveService {
  ...
  static String getRestaurantName() {
    return Hive.box<dynamic>(settingsBox).get(keyRestaurantName, defaultValue: "My Restaurant");
  }
  ...
  static String getRestaurantPhone() {
    return Hive.box<dynamic>(settingsBox).get(keyRestaurantPhone, defaultValue: "");
  }
